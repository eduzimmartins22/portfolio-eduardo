        ...
        <div className="pt-14">
          ...
          <section className="max-w-5xl mx-auto px-6 py-8 mt-4">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} custom={0} className="mb-6">
              ...
              <p className={`${t.textFaint} text-sm mt-1 ml-8`}>Projetos em andamento — em breve disponíveis</p>
            </motion.div>
            <div className="grid md:grid-cols-2 gap-6">
              <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} custom={1}>
                <Card className={`border ${t.inProgress} transition-colors h-full`}>
                  <CardContent className="p-6 space-y-4 flex flex-col h-full">
                    ...
                    <h3 className="text-lg font-semibold">App Próprio + Curso</h3>
                    <p className={`${t.textMuted} text-base leading-relaxed flex-1`}>
                      Aplicativo pessoal que também será lançado como curso completo de desenvolvimento mobile.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {["Flutter", "Em breve"].map((tag) => (
